...
/**
 * This class provides common methods and fields for sinks in the JADE-PKI.
 *
 * @author Amadeusz Żołnowski
 */
public abstract class PKISink implements Sink {

    private AgentContainer ac;
    /**
     * The logger used by the service which uses this sink.
     */
     ...
     */
    protected PKISink(Logger logger, AgentContainer ac) {
     ...
     *      or retrieved or a sink has been initialized with the different
