...
/**
 * This exception signals error in a symmetric cryptographic operation.  The
 * detailed exception is always nested within this one.
 *
 * @author Amadeusz Żołnowski
 */
public class SymmetricCryptoException extends PKIException {
     ...
     */
    public SymmetricCryptoException(Throwable cause) {
        super(cause);
    }
}
