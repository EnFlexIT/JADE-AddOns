 ...
 *
 *@author     Jamie Lawrence - Media Lab Europe, Chris van Aart - Y'All
...
public class NameConverter {
  ...
  public String toSchemaVariableName(Cls theCls, Slot theSlot) {
    ...
    return result.replaceAll("jade\\x3a","");
  }
