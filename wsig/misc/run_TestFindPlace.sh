...
#java  -classpath .:$GW:$LOG4J:$JADE:$AXIS:$UDDI4j:$WSDL com.whitestein.wsig.test.TestFindPlaceRegistration
/usr/lib/j2sdk1.4.2_01/bin/java  -classpath .:$GW:$LOG4J:$JADE:$AXIS:$UDDI4j:$WSDL com.whitestein.wsig.test.TestFindPlaceRegistration
