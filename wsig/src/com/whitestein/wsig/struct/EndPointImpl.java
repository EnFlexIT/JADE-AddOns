...
public class EndPointImpl implements EndPoint {
	...
	/**
	 * constructs new instance with type set
	 * 
	 * @param type type of this EndPoint
	 */
	public EndPointImpl( String type ) {
		this.type = type;
	}
	 ...
	 *  
	 * @param cMsg
	 * @param call who is called this end point
	 */
	public void send( CalledMessage cMsg, ReturnMessageListener listener ) throws MessageIsNotNativeException {
		// ceck the message acceptance
		if ( null == cMsg || ! isTheSameType(cMsg)) {
			throw new MessageIsNotNativeException();
		}
		// now send it by native call
		nativeSend( cMsg, listener );
	}
	...
	protected void nativeSend( CalledMessage cMsg, ReturnMessageListener listener ) {
		// details specified by extension
		System.out.println(" The nativeSend method must be overriding.");
	}
