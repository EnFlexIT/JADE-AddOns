 ...
 * @author jna
 *
 * is an operation's holder for a JComboBox.
 */
public class ComboBoxItem {
	 ...
	 *
	 * @param name a name for a JComboBox's item
	 * @param so an operation's datastructure
	 */
	public ComboBoxItem( String name, ServedOperation so ) {
		this.name = name;
		this.so = so;
	}
	...
	/**
	 * gives an operation's datastructure
	 */
