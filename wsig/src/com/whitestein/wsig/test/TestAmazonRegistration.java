 ...
 */
public class TestAmazonRegistration {

	public static Logger log = Logger.getLogger( TestAmazonRegistration.class.getName());
	...
	public synchronized void register() {
		...
		try {
			...
			String tName = "Testing Amazon SOAP's tModel.";
			String sName = "Testing Amazon SOAP's businessService.";
	...
	public static void main(String[] args) {
		...
		TestAmazonRegistration t = new TestAmazonRegistration();
