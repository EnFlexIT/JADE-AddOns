 ...
 */
public class TestAgentForFindPlace extends Agent {

	private static String nickName = "TestAgent_forFindPlace";
	private int convId = 0;
	private Logger log = Logger.getLogger(TestAgentForFindPlace.class.getName());
	public static final String wsdlOperation = "getVersion";
