...
public class TestAgent001 extends Agent {
	...
	private final static String nickName = "TestAgent001";
	private int convId = 0;
	private Category cat = Category.getInstance(TestAgent001.class.getName());
	...
	protected void setup() {
		...
		sd.setType("not-web-service");
		Property p = new Property("type","(set no-ws)");
		sd.addProperties( p );
		dfad.addServices(sd);
		sd = new ServiceDescription();
