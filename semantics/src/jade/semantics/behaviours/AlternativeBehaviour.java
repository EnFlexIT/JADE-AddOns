 ...
 */
public class AlternativeBehaviour extends SemanticBehaviour {
    ...
    /**
     * First starts the behaviour for the the left part of the alternative.
     * If the behaviour ends up with execution failure, or success, the final 
     * result is respectivly execution failure or success. If the behaviour ends
     *  up with feasibility failure, the right part of the alternative is 
