...
/**
 * This filter applies when an "and formula" is asserted in the KBase.
 * @author Vincent Pautret
 * @version Date: 2004/11/30 17:00:00  Revision: 1.0 
 */
public class X_AndFilter extends KBQueryFilter {
     ...
     */
    Formula pattern = 
		SLPatternManip.fromFormula("(and ??phi ??psi)");
