...
/**
 * This filter applies whenever an agent <i>agent1</i> expresses a piece of 
 * information towards the Jade agent <i>agent2</i>.
...
public class BeliefTransferFilter extends KBQueryFilter {
    ...
    /**
     * Returns true if the method <code>StandardKBFilterMgt.acceptBeliefTransfer</code> returns true,
     * false if not.
