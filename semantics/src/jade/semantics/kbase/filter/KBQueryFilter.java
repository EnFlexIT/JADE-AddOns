...
/**
 * This abstact class provides methods the developer has to subclass to create
 * a new filter for querying the knowledge base about the presence of a 
 * formula 
 * @author Vincent Pautret
...
public abstract class KBQueryFilter extends KBFilter {
    ...
    /**
     * Peforms the filter on the formula <code>formula</code>
     * @param formula a formula
     * @param agent a term that represent the agent is trying to apply the filter
     * @return true if the filter is applicable and succed, false if not.
     */
