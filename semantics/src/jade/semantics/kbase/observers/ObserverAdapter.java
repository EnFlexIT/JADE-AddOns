...
//		if (this instanceof CountAsObserver) {
//			System.out.println(">>>!!! waited formula="+((CountAsObserver)this).getObservedFormula());
//			System.out.println(">>>!!! observed formula="+formula);
//		}
		boolean change = super.update(formula);
		if ( change ) {
//			System.out.println("change, last="+lastQueryResultOnDirectlyObserved);
