...
public abstract class Observer {
	...
	public boolean update(Formula formula) { 
		...
		if ( updatedOnce ) {
			...
			if ( isConcerned ) {
//				System.err.println("lastQueryResultOnDirectlyObserved = "+lastQueryResultOnDirectlyObserved);
...
//				System.err.println("init lastQueryResultOnDirectlyObserved = "+lastQueryResultOnDirectlyObserved);
				updatedOnce = true;
				return false;
			}
		}
