...
{
    static int _as_expression = 0;
    static int _as_formula = 1;

    public ActionFormula(int capacity, ActionExpression as_expression, Formula as_formula)  {
      super (capacity);
    ...
    public ActionExpression as_expression() {return (ActionExpression)_nodes[_as_expression];}
    public void as_expression(ActionExpression s) {_nodes[_as_expression] = s;}
