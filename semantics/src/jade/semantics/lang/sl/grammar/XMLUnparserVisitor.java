...
public class XMLUnparserVisitor extends VisitorBase 
{
    ...
    public void visitContentNode(ContentNode node) {
        if ( _attrName != null ) {
            ...
            if ( !_attrName.equals("content") ) {
                ((org.w3c.dom.Element)_node).setAttribute("MEANS",_attrName);
            }
        }
        else {
            _node.appendChild(_doc.createElement("content")); 
    ...
    public void visitAlternativeActionExpressionNode(AlternativeActionExpressionNode node) {
        ...
        if (node.as_left_action_expression() != null)
        {
            _attrName = "left_action_expression";
            node.as_left_action_expression().accept(this);
            _attrName = null;
        }
        if (node.as_right_action_expression() != null)
        {
            _attrName = "right_action_expression";
            node.as_right_action_expression().accept(this);
            _attrName = null;
        }
        if (node.sm_action()!=null) {
            ((org.w3c.dom.Element)_node).setAttribute("action",node.sm_action().toString());
    ...
    public void visitMetaActionExpressionReferenceNode(MetaActionExpressionReferenceNode node) {
        if ( _attrName != null ) {
            _node.appendChild(_doc.createElement("meta_action_expression_reference")); 
            _node = _node.getLastChild();
            if ( !_attrName.equals("meta_action_expression_reference") ) {
                ((org.w3c.dom.Element)_node).setAttribute("MEANS",_attrName);
            }
        }
        else {
    ...
    public void visitDoneNode(DoneNode node) {
        ...
        if (node.as_expression() != null)
        {
            _attrName = "expression";
            node.as_expression().accept(this);
            _attrName = null;
        }
        if (node.as_formula() != null)
        {
