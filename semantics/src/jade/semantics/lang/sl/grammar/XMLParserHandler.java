...
public class XMLParserHandler extends DefaultHandler 
{
    ...
    public void startElement(String nsuri,String lname,String qname,Attributes atts)
    {
        ...
        if (qname.equals("content")) {
            ...
            if ( parent != null ) {
                if ( parent instanceof ListOfNodes ) {
                    ...
                    String attname = atts.getValue(atts.getIndex("MEANS"));
                    if ( attname == null ) {
                        attname = qname;
                    }
        ...
        if (qname.equals("meta_action_expression_reference")) {
            son = new MetaActionExpressionReferenceNode();
            if ( parent != null ) {
                if ( parent instanceof ListOfNodes ) {
                    ((ListOfNodes)parent).add(son);
                }
            ...
            for (int i=0; i<atts.getLength();i++) {
                ...
                if ( atts.getQName(i).equals("value") ) {
                    try {
                        Method setAttrMethod = son.getClass().getMethod("sm_value", new Class[]{ActionExpression.class});
                    } catch(Exception e) {e.printStackTrace();}
                }
                if ( atts.getQName(i).equals("action") ) {
                    try {
