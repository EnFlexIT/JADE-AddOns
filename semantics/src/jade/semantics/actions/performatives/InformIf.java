...
public class InformIf extends Alternative implements CommunicativeActionProto {
     ...
     */
    public InformIf(SemanticActionTable table, int surfacePerformative,
        ...
        rationalEffectRecognitionPattern = (rationalEffectRecognition == null ? SLPatternManip.fromFormula("(or (B ??receiver ??formula) (B ??receiver (not (??formula))))") : rationalEffectRecognition);
    ...
    public InformIf(SemanticActionTable table) {
    	this(table, ACLMessage.INFORM_IF, null, null, null);
    }
    ...
    public ActionExpression toActionExpression() throws SemanticInterpretationException {
        return CommunicativeActionImpl.toActionExpression(true, this);
    }
