...
public class Disconfirm extends Assertive {
    ...
    public Disconfirm(SemanticCapabilities capabilities,
        ...
        super(capabilities,
			  ...
			  SL.fromFormula("(and (B ??sender (not ??formula)) (B ??sender (or (B ??receiver ??formula) (U ??receiver ??formula))))"),
			  SL.fromFormula("(B ??sender (not ??formula))"),
			  SL.fromFormula("(B ??sender (B ??receiver (not ??formula)))"));
