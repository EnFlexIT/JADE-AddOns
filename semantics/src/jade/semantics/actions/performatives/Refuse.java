...
public class Refuse extends CommunicativeActionImpl {
     ...
     */
    private final Formula informContentPattern = SLPatternManip.fromFormula("(and ??condition (and (not (done ??act)) (not (I ??sender (done ??act)))))");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula disconfirmContentPattern = SLPatternManip.fromFormula("(feasible ??act)");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula informFeasibilityPreconditionPattern = SLPatternManip.fromFormula("(and (B ??sender ??formula) (not (B ??sender (or (or (B ??receiver ??formula) (B ??receiver (not ??formula))) (or (U ??receiver ??formula) (U ??receiver (not ??formula)))))))");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula disconfirmFeasibilityPreconditionPattern = SLPatternManip.fromFormula("(and (B ??sender ??formula) (not (B ??sender (or (or (B ??receiver ??formula) (B ??receiver (not ??formula))) (or (U ??receiver ??formula) (U ??receiver (not ??formula)))))))");    
     ...
     */
    public Refuse(SemanticActionTable table, int surfacePerformative,
    ...
    public Refuse(SemanticActionTable table) {
        this(table, ACLMessage.REFUSE, null, null, null);
    }
    ...
    public Formula computeFeasibilityPrecondition() throws WrongTypeException {
        Formula disconfirmFP = (Formula)SLPatternManip.instantiate(disconfirmFeasibilityPreconditionPattern,
                "sender", getAuthor(),
                "receiver", getReceiver(),
                "formula", SLPatternManip.instantiate(disconfirmContentPattern, "act", getContentElement(0)));
        Formula informFP = (Formula)SLPatternManip.instantiate(informFeasibilityPreconditionPattern,
                "sender", getAuthor(),
                "receiver", getReceiver(),
                "formula", SLPatternManip.instantiate(informContentPattern,
    ...
    public Formula computePersistentFeasibilityPreconditon() throws WrongTypeException{
        Formula disconfirmFP = (Formula)SLPatternManip.instantiate(persistentFeasibilityPreconditionPattern,
                "sender", getAuthor(),
                "formula", new NotNode((Formula)SLPatternManip.instantiate(disconfirmContentPattern, "act", getContentElement(0))));
        Formula informFP = (Formula)SLPatternManip.instantiate(persistentFeasibilityPreconditionPattern,
                "sender", getAuthor(),
                "formula", SLPatternManip.instantiate(informContentPattern,
                        "act", getContentElement(0),
                        "sender", getAuthor(),
    ...
    public Formula computePostCondition() throws WrongTypeException {
        Formula disconfirmFP = (Formula)SLPatternManip.instantiate(postConditionPattern,
                "sender", getAuthor(),
                "receiver", getReceiver(),
                "formula", new NotNode((Formula)SLPatternManip.instantiate(disconfirmContentPattern, "act", getContentElement(0))));
        Formula informFP = (Formula)SLPatternManip.instantiate(postConditionPattern,
                "sender", getAuthor(),
                "receiver", getReceiver(),
                "formula", SLPatternManip.instantiate(informContentPattern,
                        "act", getContentElement(0),
