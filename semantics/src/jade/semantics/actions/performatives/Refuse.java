...
public class Refuse extends CommunicativeActionImpl {
     ...
     */
    private final Formula informContentPattern = SL.fromFormula("(and ??condition (and (not (done ??act)) (not (I ??sender (done ??act)))))");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula disconfirmContentPattern = SL.fromFormula("(feasible ??act)");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula informFeasibilityPreconditionPattern = SL.fromFormula("(and (B ??sender ??formula) (not (B ??sender (or (or (B ??receiver ??formula) (B ??receiver (not ??formula))) (or (U ??receiver ??formula) (U ??receiver (not ??formula)))))))");
    /**
     * Pattern used to build the feasibility precondition
     */
    private final Formula disconfirmFeasibilityPreconditionPattern = SL.fromFormula("(and (B ??sender ??formula) (not (B ??sender (or (or (B ??receiver ??formula) (B ??receiver (not ??formula))) (or (U ??receiver ??formula) (U ??receiver (not ??formula)))))))");    
