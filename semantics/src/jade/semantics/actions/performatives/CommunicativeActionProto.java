...
interface CommunicativeActionProto extends CommunicativeAction {
     ...
     */
     ...
     /**
      * Returns the semantic action table associated at the action
      * @return the semantic action table associated at the action
      */
     SemanticActionTable getSemanticActionTable();
