...
public class Inform extends Assertive {
    ...
    public Inform(SemanticCapabilities capabilities,
        ...
        super(capabilities,
			  ...
			  SL.fromFormula("(and (B ??sender ??formula) (not (B ??sender (or (or (B ??receiver ??formula) (B ??receiver (not ??formula))) (or (U ??receiver ??formula) (U ??receiver (not ??formula)))))))"),
			  SL.fromFormula("(B ??sender ??formula)"),
			  SL.fromFormula("(B ??sender (B ??receiver ??formula))"));
