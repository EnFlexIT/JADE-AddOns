...
public abstract class Assertive extends CommunicativeActionImpl {
     ...
     */    
    public Assertive(SemanticActionTable table, int surfacePerformative, Class[] surfaceContentFormat, String surfaceContentFormatMessage,
            Formula rationalEffectRecognition, Formula feasibilityPrecondition, Formula persistentFeasibilityPrecondition, Formula postCondition) {
