...
public class Cancel extends Disconfirm {
     ...
     * to a cancel
     */
    private Formula disconfirmContentPattern = SL.fromFormula("(I ??sender (done ??action))");
    ...
    public Cancel(SemanticCapabilities capabilities,
        ...
        super(capabilities,
			  ...
			  (rationalEffectRecognition == null ? SL.fromFormula("(B ??receiver (not (I ??sender (done ??action))))") : rationalEffectRecognition));
    } 
