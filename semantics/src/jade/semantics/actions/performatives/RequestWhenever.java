...
public class RequestWhenever extends ActConditionInform {
     ...
     */
    public RequestWhenever(SemanticActionTable table, int surfacePerformative, Class[] surfaceContentFormat, String surfaceContentFormatMessage) {
        super(table, surfacePerformative, surfaceContentFormat, surfaceContentFormatMessage, false,
                SLPatternManip.fromFormula("(or (I ??sender (done ??act )) " +
    ...
    public RequestWhenever(SemanticActionTable table) {
        this(table, ACLMessage.REQUEST_WHENEVER, null, null);
    }
