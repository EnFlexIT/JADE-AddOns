...
public class QueryRef extends Request {
     ...
     * rational effect of this action
      */   
    public QueryRef(SemanticActionTable table, int surfacePerformative,
    ...
    public QueryRef(SemanticActionTable table) {
    	this(table, ACLMessage.QUERY_REF, null, null, null);
    }
    ...
    public SemanticAction doNewAction(Content surfaceContent) throws SemanticInterpretationException {
        ...
        requestContent.addContentElement(new InformRef(table).newAction(
                getReceiver(),
