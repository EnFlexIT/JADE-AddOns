...
public class QueryIf extends Request {
     ...
     * rational effect of this action
      */   
    public QueryIf(SemanticActionTable table, int surfacePerformative,
    ...
    public QueryIf(SemanticActionTable table) {
    	this(table, ACLMessage.QUERY_IF, null, null, null);
    }
    ...
    public SemanticAction doNewAction(Content surfaceContent) throws SemanticInterpretationException {
        ...
        requestContent.addContentElement(new InformIf(table).newAction(
                getReceiver(),
    ...
    public boolean setFeaturesFromRationalEffect(MatchResult rationalEffectMatching) throws Exception {
        Alternative informIf = (Alternative)table.getSemanticActionInstance((ActionExpression)rationalEffectMatching.getTerm("action"));
