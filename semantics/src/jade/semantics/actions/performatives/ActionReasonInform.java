...
public abstract class ActionReasonInform extends NonPrimitiveInform {
     ...
     */
    public ActionReasonInform(SemanticActionTable table, int surfacePerformative, Class[] surfaceContentFormat, String surfaceContentFormatMessage, Formula informContentPattern) {
