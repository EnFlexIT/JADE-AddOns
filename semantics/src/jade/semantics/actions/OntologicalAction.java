...
public class OntologicalAction extends SemanticActionImpl implements Cloneable {
	 ...
	 * metaVariables. These patterns may refere to the reserved metaReference "<code>??actor</code>",
	 ...
	 * @param addIt if true the action prototype is automatically added to the action table
	 */
	...
	public OntologicalAction(SemanticCapabilities capabilities,
				             String actionPattern, 
			 				 Formula postconditionPattern,
			 				 Formula preconditionPattern) {
		this(capabilities, SL.fromTerm(actionPattern), postconditionPattern, preconditionPattern);
	} 
