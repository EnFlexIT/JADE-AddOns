...
public interface SemanticInterpretationPrincipleTable {
    ...
    public final static int ALREADY_REACHED_GOAL = 3;
    ...
    public final static int REFUSE = 10; //8;
    public final static int REJECT_PROPOSAL = 11; //9;
    public final static int AGREE = 12; //10;
    public final static int PROPOSE = 13; //11;
    public final static int REQUEST_WHENEVER = 14; //12;
    public final static int SUBSCRIBE = 15; //13;
    public final static int UNSUBSCRIBE = 16; //14;
    public final static int UNREACHABLE_GOAL = 17; //15;
	
    public final static int NB_SIP_CLASSES = 18;	
