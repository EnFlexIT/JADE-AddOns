...
//		if (applyResult != null) {
//			ArrayList result = doApply(applyResult, sr);
//			if (result != null) {
//				for (Iterator srList = result.iterator() ; srList.hasNext() ; ) {
//					SemanticRepresentation producedSR = (SemanticRepresentation)srList.next();
//					producedSR.setSLRepresentation(new BelieveNode(myCapabilities.getAgentName(),
//							producedSR.getSLRepresentation()).instantiate("myself", myCapabilities.getAgentName()).getSimplifiedFormula());					
//				}
//				return result;
//			}
//		}
...
//    }
//    
//    public abstract ArrayList doApply(MatchResult applyResult, SemanticRepresentation sr) throws SemanticInterpretationPrincipleException;
