 ...
 * @version 
 */
public class CancelAction extends SemanticInterpretationPrincipleImpl {
     ...
     */
    public CancelAction(SemanticAgent agent) {
        setAgent(agent);
    ...
    public ArrayList apply(SemanticRepresentation sr)
        ...
        try {
            ...
            if (applyResult != null &&
                    !agent.getAgentName().equals(applyResult.getTerm("??agent")) &&
                    agent.getMyStandardCustomization().trapCancelAction(applyResult.getTerm("??agent"), applyResult.getActionExpression("??act"), applyResult.getFormula("??condition"))) {
...
} // End of class CancelActionFilter
