 ...
 * @version 
 */
public class DoAction extends SemanticInterpretationPrincipleImpl {
     ...
     */
    public DoAction(SemanticAgent agent) {
        setAgent(agent);
    ...
    public ArrayList apply(SemanticRepresentation sr)
        ...
        try {
            ...
            if (applyResult != null  
                    ...
                    && (agent.getMyStandardCustomization().trapDoAction(applyResult.getTerm("??agent"), 
