...
//                	ArrayList listOfFormulas = new ArrayList();
//                	Object annotation;
...
//                	// when the plan falls in execution failure, abandon the intention
//                	annotation = sr.getAnnotation(SemanticRepresentation.EXECUTION_FAILURE_KEY);
//                	if ((annotation != null) && (annotation instanceof ArrayList)) {
//                		listOfSR = (ArrayList) annotation;
//                	}
//                	else {
//                		listOfSR = new ArrayList();
//                	}
//                	listOfSR.add(new SemanticRepresentation(new NotNode(sr.getSLRepresentation())));
//                	isDoingPlanSR.putAnnotation(SemanticRepresentation.EXECUTION_FAILURE_KEY, listOfSR);
//                	
//                	// when the plan succeeds, also abandon the reached intention
//                	annotation = sr.getAnnotation(SemanticRepresentation.SUCCESS_KEY);
//                	if ((annotation != null) && (annotation instanceof ArrayList)) {
//                		listOfSR = (ArrayList) annotation;
//                	}
//                	else {
...
//                	}
//                	listOfSR.add(new SemanticRepresentation(new NotNode(sr.getSLRepresentation())));
//                	isDoingPlanSR.putAnnotation(SemanticRepresentation.SUCCESS_KEY, listOfSR);
//                	
//                	// the plan is cancelled 
//                	annotation = sr.getAnnotation(SemanticRepresentation.CANCEL_PLAN_KEY);
//                	if ((annotation != null) && (annotation instanceof ArrayList)) {
//                		listOfFormulas = (ArrayList) annotation;
//                	}
//                	else {
//                		listOfFormulas = new ArrayList();
//                	}
//                	// when the intention is abandoned
//                	listOfFormulas.add(new NotNode(sr.getSLRepresentation()));
//                	// and when the plan is stopped (Not Bel-i (is_doing i plan))
//                	listOfFormulas.add(new NotNode(new BelieveNode(myCapabilities.getAgentName(),
//                			new PredicateNode(
//        					new SymbolNode("is_doing"),
//        					new ListOfTerm(new Term[] {myCapabilities.getAgentName(),plan})))));
//                	isDoingPlanSR.putAnnotation(SemanticRepresentation.CANCEL_PLAN_KEY, listOfFormulas);
//                	
//                	// when the plan falls in feasibility failure, interpret the same 
//                	// incoming SR with next SIPs
//                	annotation = sr.getAnnotation(SemanticRepresentation.FEASIBILITY_FAILURE_KEY);
//                	if ((annotation != null) && (annotation instanceof ArrayList)) {
//                		listOfSR = (ArrayList) annotation;
//                	}
//                	else {
//                		listOfSR = new ArrayList();
//                	}
//                	listOfSR.add(new SemanticRepresentation(sr,getIndex()+1));
//                	isDoingPlanSR.putAnnotation(SemanticRepresentation.FEASIBILITY_FAILURE_KEY, listOfSR);
