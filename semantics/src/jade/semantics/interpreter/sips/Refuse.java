...
public class Refuse extends SemanticInterpretationPrinciple {
    ...
    throws SemanticInterpretationPrincipleException {
        try {
            ...
            if (applyResult != null &&
                    myCapabilities.getMyStandardCustomization().handleRefuse(applyResult.getTerm("agent"), (ActionExpression)applyResult.getTerm("act"), applyResult.getFormula("condition"))) {
