...
public class ActionFeatures extends SemanticInterpretationPrinciple {
    ...
    public ActionFeatures(SemanticCapabilities capabilities, boolean activeFP) {
        ...
        feasibilityPreconditonPattern = SL.fromFormula("(B " + myCapabilities.getAgentName() + " (done ??act ??fp))");
        persistentPreconditionPattern = SL.fromFormula("(B " + myCapabilities.getAgentName() + " ??p)");
        intentionalEffectPattern = SL.fromFormula("(B " + myCapabilities.getAgentName() + " (I ??sender ??re))");
        postConditionPattern = SL.fromFormula("(B " + myCapabilities.getAgentName() + " ??pc)");
    }
