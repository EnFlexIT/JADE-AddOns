...
public class DefaultSemanticInterpretationPrincipleLoader {
	
	public void load(SemanticInterpretationPrincipleTable table, SemanticCapabilities capabilities) {
	       ...
	       #PJAVA_INCLUDE_END*/
		   table.addSemanticInterpretationPrinciple(new AlreadyReachedGoal(capabilities));
