...
/**
 * This class provides useful methods to create {@link CommunicativeAction}
 * instances from the parameters of the corresponding FIPA-ACL communicative act
 * (i.e. each element conveyed by the content of the act, plus a receiver or an
 * array of receiver).
 * 
...
public class CommunicativeActionFactory {
	   ...
	   private SemanticActionTable semanticActionTable;
	    ...
	    * @param name the name of the sender agent (that is "myself"), given as a
	    *             FIPA-SL term representing the agent's AID
	    */
	    ...
	    */
	    public CommunicativeAction createAcceptProposal(ActionExpression action, Formula condition, Term[] receivers) {
	       ...
	       try {
	           ...
	           return (CommunicativeAction)prototype.newAction(agentName, 
	    ...
	    * @return a communicative action Request
	     ...
	     */
	    static final Content UNSUBSCRIBE_CONTENT1 = SL.fromContent("((not (I ??agent (done (action ??receiver (INFORM-REF :sender ??receiver :receiver (set ??agent) :content ??ire))))))");
	     ...
	     * Content of an Unsubscribe action
	     */
	    static final Content UNSUBSCRIBE_CONTENT2 = SL.fromContent("((not (I ??agent (done ??action))))");
	     ...
	     * Content of an Unsubscribe action
	     */
	    static final Content UNSUBSCRIBE_CONTENT3 = SL.fromContent("((or " +
