...
public class SingleNumValueDefinition extends FiltersDefinition {
   ...
   {        
       VALUE_X_PATTERN = SL.fromFormula("("+name+" ??X)");
       
       NOT_VALUE_X_PATTERN = SL.fromFormula("(not ("+name+" ??X))");
       
       VALUE_GT_X_PATTERN = SL.fromFormula("("+name+"_gt ??X)");
       
       NOT_VALUE_GT_X_PATTERN = SL.fromFormula("(not ("+name+"_gt ??X))");

       IOTA_VALUE = (IdentifyingExpression)SL.fromTerm("(iota ?y (B ??agent ("+name+" ?y)))");
       
       IOTA_VALUE_GT = (IdentifyingExpression)SL.fromTerm("(iota ?y (B ??agent ("+name+"_gt ?y)))");
       
       IOTA_VALUE_NOT_GT = (IdentifyingExpression)SL.fromTerm("(iota ?y (B ??agent (not ("+name+"_gt ?y))))");
