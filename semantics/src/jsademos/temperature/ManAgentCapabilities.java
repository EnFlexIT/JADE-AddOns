...
public class ManAgentCapabilities extends SemanticCapabilities {
   ...
   public void setMotherFromAID(AID mother) {
       motherTerm = SL.fromTerm(mother.toString());
...
//		   });
           ...
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(temperature_gt 20)"),
                   SL.fromFormula("(and (I ??myself (not (wearing ??myself trousers)))" +
           ...
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(temperature_gt 15.0)"),
                   SL.fromFormula("(and (I ??myself (not (wearing ??myself pullover)))" +
                                       "(I ??myself (not (wearing ??myself coat)))" +
                                       "(I ??myself (not (wearing ??myself cap))))"),
                   getSemanticInterpreterBehaviour()));
           
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(temperature_gt 10)"),
                   SL.fromFormula("(and (I ??myself (not (wearing ??myself coat)))" +
                                       "(I ??myself (not (wearing ??myself cap))))))"),
                   getSemanticInterpreterBehaviour()));
           
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(temperature_gt 0)"),
                   SL.fromFormula("(I ??myself (not (wearing ??myself cap)))"),
                   getSemanticInterpreterBehaviour()));
           ...
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(not (temperature_gt 15))"),
                   SL.fromFormula("(and (I ??myself (wearing ??myself pullover))" +
                                       "(I ??myself (wearing ??myself trousers)))"),
                   getSemanticInterpreterBehaviour()));
           
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(not (temperature_gt 10))"),
                   SL.fromFormula("(and (I ??myself (wearing ??myself coat))" +
                                       "(I ??myself (wearing ??myself pullover))" +
                                       "(I ??myself (wearing ??myself trousers)))"),
                   getSemanticInterpreterBehaviour()));
           
           kb.addObserver(new EventCreationObserver(kb,
                   SL.fromFormula("(not (temperature_gt 0))"),
                   SL.fromFormula("(and (I ??myself (wearing ??myself cap))" +
           ...
           // -----------------------
           kb.addClosedPredicate(SL.fromFormula("(wearing "+getAgentName()+" ??c)"));

		   Formula initialKPattern = 
               SL.fromFormula("(not (wearing ??myself ??clothing))");
 
		   // In the initial state, the son does not wear clothing
           interpret(initialKPattern.instantiate("clothing", new WordConstantNode("cap")));
           interpret(initialKPattern.instantiate("clothing", new WordConstantNode("coat")));
           interpret(initialKPattern.instantiate("clothing", new WordConstantNode("trousers")));
           interpret(initialKPattern.instantiate("clothing", new WordConstantNode("pullover")));
       }
...
//	   });
   ...
   public SemanticActionTable setupSemanticActions() {
       ...
       table.addSemanticAction(new OntologicalAction(this,
               ...
               SL.fromFormula("(wearing ??actor ??clothing)"),
               SL.fromFormula("(not (wearing ??actor ??clothing))")) {
        ...
        getMySemanticActionTable().addSemanticAction( new OntologicalAction1(getMySemanticActionTable(),
            "(PUT-ON :clothing ??clothing)",
            SL.fromFormula("(wearing ??sender ??clothing)"),
            SL.fromFormula("(not (wearing ??sender ??clothing))"), myAgent) );//Add the action to take off a clothing.
        #DOTNET_INCLUDE_END*/
       ...
       getMySemanticActionTable().addSemanticAction(new OntologicalAction2(getMySemanticActionTable(),
               "(TAKE-OFF :clothing ??clothing)",
               SL.fromFormula("(not (wearing ??sender ??clothing))"),
               SL.fromFormula("(wearing ??sender ??clothing)"), myAgent));
        #DOTNET_INCLUDE_END*/
