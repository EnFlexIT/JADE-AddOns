...
public class BookBuyerAgentGui extends JFrame implements IBookBuyerAgentGui {
	...
	static final IdentifyingExpression BOOKS_FOR_SALE_IRE = (IdentifyingExpression)
    	SL.fromTerm("(some (sequence ?i ?t) (exists ?a (and (for_sale ?i ?a) (title ?i ?t))))");

	static final JLabel CART_LABEL = new JLabel(new ImageIcon("./cart.gif"), JLabel.RIGHT);
	...
	public BookBuyerAgentGui(BookBuyerCapabilities sc) {
		...
		buttonPanel.add(new JButton(new AbstractAction("Purchase") {
			public void actionPerformed(java.awt.event.ActionEvent e) {	
				Constant isbn = new StringConstantNode(isbnField.getText());
				Constant price = new RealConstantNode(new Double(priceField.getText()));
				Constant title = new StringConstantNode(titleField.getText());
