 ...
 */
public class ManAgent extends SemanticAgentBase {
    ...
    final Content REQUEST_WHENEVER_SUBSCRIBE_PATTERN = 
        SLPatternManip.fromContent("((action ??thermometer (INFORM :content ??content :receiver (set ??me) :sender ??thermometer)) ??phi)");
    
    /**
     * Inform unsubscribe pattern
     */
    final Content INFORM_UNSUBSCRIBE_PATTERN = 
        SLPatternManip.fromContent("((or " +
    ...
    public void setup() {
        ...
        ((ManAgentCapabilities)getSemanticCapabilities()).setMotherAIDfromString(getArguments()[2].toString());
        setupGui();
    } // End of setup/0
            ...
            manPanel = (new JPanel() {
                public void paintComponent(Graphics g) {
                    ...
                    for (int i = array.length - 1; i >=0 ; i--) {
                        ...
                        g.drawImage(DemoAgentGui.getIcon(clothing).getImage(), 0, 0, null);
                    }
                }});
        }
