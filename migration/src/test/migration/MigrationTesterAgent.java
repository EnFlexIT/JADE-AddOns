...
public class MigrationTesterAgent extends TesterAgent {
  ...
  public static final String MTP_DEFAULT =
  ...
  public static final String MOBILITY_SERVICE = 
  ...
  public static final String AGENTS_PATH = CURRENT_DIR + File.separator + "src" + File.separator + 
  "test" + File.separator + "migration" + File.separator + "path1";
   // "migration" + java.io.File.separator + "path1";
  public static final String AGENTS_PATH_2 = CURRENT_DIR + File.separator + "src" + File.separator + 
  "test" + File.separator + "migration" + File.separator + "path2";

  protected TestGroup getTestGroup() {
    TestGroup tg =
      new TestGroup("test/migration/migrationTestsList.xml") {
      ...
      public void initialize(Agent a) throws TestException {
        try {
          ...
          cmtp = 
             TestUtility.launchJadeInstance("Container-mtp", addClasspath, new String("-container -host "+TestUtility.getLocalHostName()+" -port "+String.valueOf(Test.DEFAULT_PORT)+" -mtp jade.mtp.http.MessageTransportProtocol(http://"+InetAddress.getLocalHost().getHostName()+":8888/acc)"), null);
          // Start the remote platform with the specified MTP
          jc1 =
            TestUtility.launchJadeInstance(
