...
public abstract interface JmsProviderManager {
   ...
   */
  public abstract void activate (InChannel.Dispatcher disp, JMSAddress jmsTA)
                          throws MTPException;
   ...
   */
  public abstract void deactivate (JMSAddress jmsTA) throws MTPException;
   ...
   */
  public abstract void deliver (JMSAddress jmsTA, Envelope env, byte[] payload)
                         throws MTPException;
   ...
   */
  public abstract QueueConnection getBrokerConnection (JMSAddress jmsTA)
                                                throws MTPException;
   ...
   */
  public abstract ProviderAdmin getProviderAdmin (String providerType)
                                           throws MTPException;
}
