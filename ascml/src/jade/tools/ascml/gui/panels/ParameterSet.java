...
public class ParameterSet extends AbstractPanel implements ActionListener
{
	private jade.tools.ascml.absmodel.IParameterSet[] parameterSet;
	 ...
	 */
	public ParameterSet(AbstractMainPanel mainPanel, Object model)
	{
		super(mainPanel);
		...
		{
			this.parameterSet = ((IAgentType)model).getParameterSets();
		}
		else
		{
			this.parameterSet = ((IAgentInstance)model).getParameterSets();
		}
	...
	private JPanel createParameterPanel()
	{
		...
		table = new JTable(new ParameterTableModel(parameterSet, true));
