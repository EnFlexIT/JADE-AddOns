 ...
 */
public class TestGoogleRegistration extends HTTPServer {

	public static Logger log = Logger.getLogger( TestGoogleRegistration.class.getName());
	...
	/**
	 * starts a new TestGoogleRegistration on a socket given
	 * 
	 * @param socket a server socket used
	 */
	public TestGoogleRegistration( ServerSocket socket ) {
		super( socket, "com.whitestein.wsig.test.TestGoogleRegistrationConnection" );
		try {
			String host = socket.getInetAddress().getLocalHost().getHostName();
			log.debug(" a local host's name = " + host );
			setHostName( host );
	...
	public synchronized void register() {
		...
		try {
			...
			String tName = "Testing Google SOAP's tModel.";
			String sName = "Testing Google SOAP's businessService.";
	...
	public static void main(String[] args) {
		...
		TestGoogleRegistration t = new TestGoogleRegistration( socket );
		t.port = parsePort( args );
