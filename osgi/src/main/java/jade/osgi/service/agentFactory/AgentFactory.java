...
public abstract class AgentFactory {
	...
	public void init(Bundle bundle) {
		...
		this.serviceRegistration = context.registerService(AgentFactory.class.getName(), this, properties);
		System.out.println("AgentFactory service for bundle " + myBundle.getSymbolicName() + " registered");
	}
