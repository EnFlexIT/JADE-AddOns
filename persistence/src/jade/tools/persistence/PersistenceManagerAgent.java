...
public class PersistenceManagerAgent extends ToolAgent {
	...
	public AMSClientBehaviour(String an, ACLMessage request) {
        ...
        protected void handleNotUnderstood(ACLMessage reply) {
            myGUI.showErrorDialog("NOT-UNDERSTOOD received during " + actionName, reply);
        }
    ...
    // External method; called by the GUI
    public void readRepository(final String nodeName, final String repositoryName) {
        ...
        addBehaviour(new OneShotBehaviour() {
            ...
            public void action() {
                ...
                try {
                    // Retrieve the list of the repositories
                    PersistenceHelper helper = (PersistenceHelper)getHelper(PersistenceHelper.NAME);
                    String[] savedAgents = helper.getSavedAgents(nodeName, repositoryName);
                    String[] frozenAgents = helper.getFrozenAgents(nodeName, repositoryName);
                    String[] savedContainers = helper.getSavedContainers(nodeName, repositoryName);

                    // Notify the GUI about it
                    myGUI.repositoryRead(savedAgents, frozenAgents, savedContainers);
