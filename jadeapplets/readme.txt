...
For running the example the following steps should be followed:
	...
	4. Run startServer.bat - this will start the JADE platform on the given port (the first parameter) and create the server container (with the HTTP MTP using the port given by the second parameter) and the server agent 
	5. Edit clientJadeApplet.html and fill in properly the host name of the jade platform, the port of the jade platform, and the applet container port. 
	6. Start clientJadeApplet.html
